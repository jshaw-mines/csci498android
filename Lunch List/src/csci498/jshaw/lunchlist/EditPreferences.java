	...
	SharedPreferences.OnSharedPreferenceChangeListener onChange = new SharedPreferences.OnSharedPreferenceChangeListener()
	{
		...
		public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
			if("alarm".equals(key))
			{
				...
				ComponentName comp = new ComponentName(EditPreferences.this, OnBootReceiver.class);
				
				getPackageManager().setComponentEnabledSetting(comp, flag, PackageManager.DONT_KILL_APP);
